...
#define PCTL(pad, ctrl)
static const iomux_v3_cfg_t nitrogen6sx_pads[] = {
	/* Audmux */
...
#define GP_ECSPI5_CS		IMX_GPIO_NR(4, 7)
...
#define GP_BACKLIGHT_LVDS	IMX_GPIO_NR(1, 13)
	IOMUX_PAD_CTRL(GPIO1_IO13__GPIO1_IO_13, OUTPUT_40OHM),
...
static iomux_v3_cfg_t const enet_gpio_pads[] = {
...
static int setup_fec(void)
{
	...
	imx_iomux_v3_setup_multiple_pads(enet_gpio_pads, ARRAY_SIZE(enet_gpio_pads));
...
int board_early_init_f(void)
{
	...
	imx_iomux_v3_setup_multiple_pads(nitrogen6sx_pads, ARRAY_SIZE(nitrogen6sx_pads));
	return 0;
}
